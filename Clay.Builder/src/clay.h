...
CLAY_DLL_EXPORT() Clay_Arena Clay_CreateArenaWithCapacityAndMemory(uint32_t capacity, void *offset);
...
CLAY_DLL_EXPORT() void Clay_SetMeasureTextFunction(Clay_Dimensions (*measureTextFunction)(Clay_String *text, Clay_TextElementConfig *config));
...
CLAY_DLL_EXPORT() Clay_LayoutConfig * Clay__StoreLayoutConfig(Clay_LayoutConfig config);
CLAY_DLL_EXPORT() void Clay__ElementPostConfiguration(void);
CLAY_DLL_EXPORT() void Clay__AttachId(Clay_ElementId id);
CLAY_DLL_EXPORT() void Clay__AttachLayoutConfig(Clay_LayoutConfig *config);
CLAY_DLL_EXPORT() void Clay__AttachElementConfig(Clay_ElementConfigUnion config, Clay__ElementConfigType type);
CLAY_DLL_EXPORT() Clay_RectangleElementConfig * Clay__StoreRectangleElementConfig(Clay_RectangleElementConfig config);
CLAY_DLL_EXPORT() Clay_TextElementConfig * Clay__StoreTextElementConfig(Clay_TextElementConfig config);
CLAY_DLL_EXPORT() Clay_ImageElementConfig * Clay__StoreImageElementConfig(Clay_ImageElementConfig config);
CLAY_DLL_EXPORT() Clay_FloatingElementConfig * Clay__StoreFloatingElementConfig(Clay_FloatingElementConfig config);
CLAY_DLL_EXPORT() Clay_CustomElementConfig * Clay__StoreCustomElementConfig(Clay_CustomElementConfig config);
CLAY_DLL_EXPORT() Clay_ScrollElementConfig * Clay__StoreScrollElementConfig(Clay_ScrollElementConfig config);
CLAY_DLL_EXPORT() Clay_BorderElementConfig * Clay__StoreBorderElementConfig(Clay_BorderElementConfig config);
